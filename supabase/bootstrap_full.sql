...
CREATE POLICY "Service role full access hub_generated_content" ON hub_generated_content FOR ALL USING (true) WITH CHECK (true);
COMMENT ON TABLE hub_generated_content IS 'Metadados do conteúdo gerado no Hub para rastreabilidade.';
