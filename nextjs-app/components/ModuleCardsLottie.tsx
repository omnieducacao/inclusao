...
function ModuleCardWithLottie({
  ...
  return (
    <motion.div
      className={`group relative block transition-all duration-300 ease-out stagger-item hover:z-50 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
...
export function IntelligenceModuleCard({ href, title, desc }: IntelligenceModuleProps) {
  ...
  return (
    <div>
      ...
      <Link
        href={href}
        className="group relative block rounded-2xl transition-all duration-300 ease-out
          hover:-translate-y-2 hover:scale-[1.05] hover:z-50 hover:shadow-premium-xl shadow-premium
