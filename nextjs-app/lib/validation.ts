...
export const criarAtividadeSchema = z.object({
    ...
    estudante: z.object({
        ...
        hiperfoco: z.any().optional(),
        perfil: z.string().optional(),
        ia_sugestao: z.string().optional(),
        nivel_suporte: z.any().optional(),
        barreiras: z.any().optional(),
        estrategias_acesso: z.any().optional(),
        estrategias_ensino: z.any().optional(),
        estrategias_avaliacao: z.any().optional(),
        potencialidades: z.any().optional(),
        ponte_pedagogica: z.any().optional(),
    }).optional(),
