// ============================================================
// OMNISFERA — Tipos TypeScript do Motor de IA (Avaliação Diagnóstica)
// Adaptado de omnisfera-ai-package/types/omnisfera.ts
// ============================================================
...
export type DisciplinaEF = typeof DISCIPLINAS_EF[number]

// ── Status do fluxo PEI por Disciplina ────────────────────────
