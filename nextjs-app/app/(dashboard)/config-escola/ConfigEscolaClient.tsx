  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="mt-4 p-6 rounded-2xl border border-slate-200/50 bg-gradient-to-br from-slate-50 to-white min-h-[180px]">
...
function AddClassForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-wrap gap-4 items-end p-6 rounded-2xl border border-slate-200/50 bg-white shadow-sm min-h-[180px]">
      <div>
