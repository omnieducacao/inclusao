  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <div>
        ...
        <Input type="number" min={4} max={24} value={duracao} onChange={(e) => setDuracao(Number(e.target.value))} className="w-full" />
      </div>
      <div>
        ...
        <Select
          ...
          options={FREQUENCIAS.map((f: string) => ({ value: f, label: f.replace("_", " ") }))}
        />
      </div>
