        ...
        <div className="min-h-screen" style={{ background: "var(--bg-primary)" }}>
            ...
            <section className="relative overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-6 pt-20 pb-24 flex flex-col items-center text-center">
                    ...
                    >
                        Recupere seus finais de semana. Crie PEIs, adaptações curriculares, avaliações diagnósticas e sequências didáticas instantaneamente usando 5 motores de Inteligência Artificial educacional.
                    </p>
