...
# ==============================================================================
APP_VERSION = "v2.6 - Menu Colado no Topo"
...
# ==============================================================================
# 2. CSS & DESIGN SYSTEM (AJUSTE DE ESPAÇAMENTO MÁXIMO)
# ==============================================================================
st.markdown(
    """
<style>
...
/* --- AJUSTE CRÍTICO: COLAR O CONTEÚDO NO TOPO --- */
.block-container {
    padding-top: 80px !important; /* Exatamente a altura da Topbar */
...
# ==============================================================================
# 🟢 BLOCO: MENU DE ACESSO RÁPIDO (ISOLADO E COLADO NO TOPO)
# ==============================================================================
def render_quick_access_bar():
    """
    Este bloco define os botões pequenos e coloridos que ficam
    IMEDIATAMENTE abaixo do topo da página.
    """
    
    # CSS EXCLUSIVO PARA O MENU RÁPIDO
    st.markdown("""
    <style>
        /* Container para puxar os botões para cima */
        .qa-container {
    ...
    # Renderização dos Botões envoltos em .qa-btn e .qa-container
    with c1: 
        st.markdown('<div class="qa-container qa-btn">', unsafe_allow_html=True)
